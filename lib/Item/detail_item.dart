      ...
      body: Column(
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(products[widget.idx]['description'],softWrap: _txtdetail,)
          ...
          Container(
            ...
            child: TextButton(child: Text('Thêm vào giỏ hàng', style: TextStyle( fontSize: 18, color: Colors.green[500]),),onPressed: (){},),
          )
          //đánh giá
        ],
      ),
